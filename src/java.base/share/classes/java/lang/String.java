...
/**
 * String 类，被 final 修饰，不可被继承
 */
public final class String
    implements java.io.Serializable, Comparable<String>, CharSequence {

    /**
     * 存储 String 中的字符数组， private 修饰，不可被外部访问。
     * 被 final 修饰，不可修改，所以说 String 类的引用是不可修改的。
     * 但是可以通过反射获取 value 的值，修改该数组的内容。
     * <p>
     ...
     * <p>
     * 如果 String 的压缩功能未开启，那么 String 中字节的存储编码格式总是为 UTF16
     * <p>
     ...
     * <p>
     * COMPACT_STRINGS 由 JVM 设置，在静态代码中赋值，在 JVM 初始化的时候就赋上了值。
     */
    ...
    /**
     * 构造方法，创建一个新的对象，与传入对象是一致的，因为 String 对象是不可变对象，
     * 所有其实该构造方法也是没有意义的。
     * <p>
     * Initializes a newly created {@code String} object so that it represents
    ...
    /**
     * 根据 char 数组创建新的 String 对象。
     * char 数组改变不会影响该 String 对象。
     * <p>
    ...
    /**
     * LATIN1 编码：
     * 是一个 8 比特的字符集，定义了 256 个字符，前 128 个字符与 ASCII 字符完全一致
     * 只占一个字节
     */
    @Native
    ...
    /**
     * UTF16 编码：
     * 是一个可变长度编码，可以是一个或者两个 16 比特。
     * 所以至少占了 2 个字节，比 LATIN1 编码方式占的存储要大。
     */
    @Native
